...
public class JedisTemplate {
	private static Log log = LogFactory.getLog(JedisTemplate.class);
	...
	// ////////////// 公共 ///////////////////////////
	/**
	 * 删除keys, 如果所有key存在返回true, 否则返回false。
	 */
	 ...
	 * @return 被删除的key的个数。
	 */
	public long del(final String pattern) {
	...
	public Long exprie(final String key, final int seconds) {
		return execute(new JedisAction<Long>() {
			@Override
			public Long action(Jedis jedis) {
	...
	public static void main(String[] args) {
		JedisTemplate jedis = JedisTemplateFactory
				.getTemplate("redis://10.28.6.53");
